...
class _TransactionPageState extends State<TransactionPage>
  ...
  late TransactionFormNotifier _formNotifier;
  ...
  void initState() {
    ...
    // Register save callback so center FAB can trigger save
    _formNotifier.registerSaveCallback(_processTransaction);
  ...
  void dispose() {
    ...
    _formNotifier.unregisterSaveCallback();
    ...
    return Scaffold(
      ...
      body: BlocListener<TransactionBloc, TransactionState>(
        listenWhen: (prev, curr) =>
            curr is TransactionSuccess || curr is TransactionError,
        listener: (context, state) {
          if (state is TransactionSuccess) {
            NotificationService().showTransactionSuccess(state.message);
            ...
            _formNotifier.markAsSaved();
          } else if (state is TransactionError) {
            NotificationService().showTransactionError(state.message);
          }
        },
        ...
        ), // Close BlocListener for TransactionBloc (receipt)
      ), // Close BlocListener for TransactionBloc (save)
    );
  }
